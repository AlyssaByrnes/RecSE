...
We define the following function in our Coq model, which takes a symbolic state (the list of
\textsf{SymbolicAssignemnts}) and a mapping from symbols to literals, and
...
\begin{itemize}
  \item $\mathit{instantiateState}(\vv{\textsf{SymbolicAssignment}},
    \textsf{SymbolicMapping}) : \vv{\textsf{Assignment}}$.
\end{itemize}
