...
\ldots>$, where each element is a tuple as defined by the type. The list is defined inductively and has unbounded length in the Coq
...
\textsf{Assignment} elements. As in our abstract model, it is deterministic and left-total:
...
\begin{itemize}
  ...
  \item $\textsf{SymbolicAssignment} : (r: \textsf{Register},
    ...
    represents the assignmet of an expression $\symexpression \in
